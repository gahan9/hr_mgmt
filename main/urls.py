...
urlpatterns = [
    ...
    # url(r'^api/survey/(?P<pk>[^/.]+)/steps/3$', QuestionSet, name="question_editor"),
    # url(r'^api/survey/(?P<pk>\d+)/steps/4$', TimeLineSet, name="question_editor"),
    # url(r'^api/survey/(?P<pk>\d+)/steps/5$', QuestionSet, name="question_editor"),
